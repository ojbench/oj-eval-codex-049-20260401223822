...
def main():
    ...
    code_parser = subparsers.add_parser("submit-file", help="Submit single source file content")
    code_parser.add_argument("--problem-id", type=int, required=True, help="Problem ID")
    code_parser.add_argument("--language", type=str, required=True, choices=["c", "cpp"], help="Language")
    code_parser.add_argument("--file", type=str, required=True, help="Path to source file")
